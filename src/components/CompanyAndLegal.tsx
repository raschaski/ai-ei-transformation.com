      ...
      <section className="company-hero">
        <div><span className="eyebrow">Mitarbeitergesundheit im Mittelstand</span><h1>KI-Kompetenz braucht emotionale Gesundheit.</h1><p>Mindful AI verbindet Selbstreflexion, gesunde Arbeitsrhythmen und verantwortungsvolle Tool-Nutzung – ohne individuelle Beschäftigtendaten zur Leistungskontrolle zu machen.</p>
          <a
            ...
            href="https://calendly.com/undercover_trainer/erstgesprach"
            target="_blank"
            rel="noreferrer"
          >
            Unverbindlichen Pilot besprechen
          </a>
...
export function PrivacyView() {
  return <LegalLayout title="Datenschutzerklärung" updated="Stand: 23. Juli 2026">
    ...
    <h2>4. Einwilligungen und Rechtsgrundlagen</h2><p>Vor der Nutzung werden die Kenntnisnahme der Datenschutzerklärung und die ausdrückliche Einwilligung in die Verarbeitung selbst eingegebener Gesundheitsangaben getrennt abgefragt und mit Textversion und Zeitpunkt dokumentiert. Angaben zum emotionalen Befinden können Gesundheitsdaten im Sinne von Art. 9 DSGVO sein. Die zusätzliche Kontakteinwilligung beruht auf Art. 6 Abs. 1 lit. a DSGVO und erlaubt den persönlichen Kontakt per E-Mail sowie – nur bei freiwilliger Angabe – telefonisch zu Teilnahme, Rückfragen und Informationen zu Mindful AI. Diese Kontakteinwilligung ist freiwillig, nicht vorausgewählt und keine Voraussetzung für die App-Nutzung. Einwilligungen können jederzeit mit Wirkung für die Zukunft widerrufen werden. Soweit Daten für Anmeldung, Sicherheit und Bereitstellung erforderlich sind, kommen daneben Art. 6 Abs. 1 lit. b oder lit. f DSGVO in Betracht. Die konkrete Rechtsgrundlagenprüfung muss vor dem Live-Betrieb abgeschlossen werden.</p>
    <h2>5. Empfänger und technische Dienste</h2><p>Kontaktdaten werden weder verkauft noch an fremde Unternehmen für deren eigene Werbung oder ihren Vertrieb weitergegeben. Eine Verarbeitung erfolgt jedoch durch die für den Betrieb erforderlichen, vertraglich gebundenen technischen Dienstleister:</p><ul><li><strong>GitHub Pages:</strong> Auslieferung des statischen Frontends; GitHub kann technische Zugriffsdaten verarbeiten.</li><li><strong>Supabase:</strong> Passwortlose Anmeldung, Datenbank und serverseitige Funktionen, einschließlich der Speicherung freiwillig hinterlegter Kontaktdaten. Das Projekt soll in einer europäischen Region betrieben werden; Row-Level Security trennt Benutzerkonten.</li><li><strong>OpenAI als Sprachmodell-Anbieter:</strong> Nur nach einer ausdrücklichen Aktion für eine KI-Reflexion, KI-Kompass-Vertiefung oder KI-Tool-Beratung. Kontaktdaten werden nicht für diese KI-Funktionen übermittelt. Je nach Funktion werden ausgewählte Zahlenwerte und Kategorien, ausdrücklich freigegebene Testantworten oder eine anonymisierte Aufgabenbeschreibung übertragen. Freie Tagebuchnotizen werden nicht übermittelt. Anbieterregion, Auftragsverarbeitung, Löschkonfiguration und internationale Transfers sind vor Aktivierung verbindlich zu dokumentieren.</li><li><strong>OAuth-Anbieter:</strong> Nur wenn eine Anmeldung über den freiwillig gewählten Anbieter aktiviert und genutzt wird.</li></ul>
    <h2>6. Lokale Speicherung, Cookies, Android-Berechtigungen und TLS</h2><p>Im Demo-Modus werden Eingaben ausschließlich im lokalen Speicher des Browsers beziehungsweise der App abgelegt. Timer-Zustände können ebenfalls lokal gespeichert werden. Die App setzt selbst keine Marketing- oder Analyse-Cookies ein. Die Android-App benötigt lediglich Internetzugriff und fordert keine Berechtigungen für Kamera, Mikrofon, Standort, Kontakte, Kalender, Aktivitätssensoren oder Health Connect an. Technisch notwendige Speicherzugriffe dienen der ausdrücklich gewünschten App-Funktion. Verbindungen werden per TLS verschlüsselt.</p>
    ...
    <h2>8. Speicherdauer, Widerruf und Löschung</h2><p>Persönliche App-Daten einschließlich Kontaktdaten und Einwilligungsnachweis bleiben gespeichert, bis sie in der App gelöscht, die Kontakteinwilligung widerrufen oder das Konto beendet wird, soweit keine gesetzlichen Nachweis- oder Aufbewahrungspflichten entgegenstehen. Ein Widerruf ist per E-Mail an <a href="mailto:trainer@the-undercover-trainer.com">trainer@the-undercover-trainer.com</a> oder durch Löschen unter „Daten &amp; Schutz“ möglich. Unter „Daten &amp; Schutz“ können App-Daten exportiert und gelöscht sowie das Benutzerkonto vollständig beendet werden. Wer keinen Zugriff mehr auf die App hat, kann die Löschung über die öffentliche Löschseite anfragen. Technische Protokolle der Dienstleister richten sich nach den vertraglich festgelegten Fristen. Verbindliche Löschfristen sind vor Veröffentlichung im Verzeichnis der Verarbeitungstätigkeiten festzulegen.</p>
    <h2>9. Rechte betroffener Personen</h2><p>Du hast – abhängig von den gesetzlichen Voraussetzungen – Rechte auf Auskunft, Berichtigung, Löschung, Einschränkung, Datenübertragbarkeit, Widerspruch und Widerruf einer Einwilligung. Ein Widerruf berührt nicht die Rechtmäßigkeit der Verarbeitung bis zum Widerruf. Außerdem besteht ein Beschwerderecht bei einer Datenschutzaufsichtsbehörde.</p>
    ...
    <h2>11. KI-Transparenz und menschliche Kontrolle</h2><p>Optionale Sprachmodell-Ausgaben sind als KI-generiert gekennzeichnet. Vor dem Start werden Zweck, Datenumfang und Grenzen erklärt. Die Ausgabe ist unverbindlich, kann Fehler enthalten und darf keine medizinische, arbeitsrechtliche oder personelle Entscheidung ersetzen. Tool-Empfehlungen führen keine externe Aktion aus und müssen auf Verfügbarkeit, Unternehmensfreigabe und Eignung geprüft werden. Hinweise oder Vorfälle können an die verantwortliche Stelle gemeldet werden.</p>
    <h2>12. Sicherheitsmaßnahmen</h2><p>Vorgesehen sind TLS, verschlüsselte Speicherung durch den Infrastrukturprovider, Zugriffstrennung per Row-Level Security, Datenminimierung, serverseitige API-Schlüssel, keine Übertragung freier Tagebuchnotizen an das Sprachmodell sowie Export- und Löschfunktionen.</p>
    <p className="legal-links"><a href={`${import.meta.env.BASE_URL}datenschutz.html`} target="_blank" rel="noreferrer">Öffentliche Datenschutzerklärung <ExternalLink size={14}/></a><a href={`${import.meta.env.BASE_URL}account-loeschen.html`} target="_blank" rel="noreferrer">Konto- und Datenlöschung <ExternalLink size={14}/></a><a href="https://docs.github.com/de/site-policy/privacy-policies/github-general-privacy-statement" target="_blank" rel="noreferrer">GitHub-Datenschutz <ExternalLink size={14}/></a><a href="https://supabase.com/privacy" target="_blank" rel="noreferrer">Supabase-Datenschutz <ExternalLink size={14}/></a></p>
  </LegalLayout>;
}
  ...
  return (
    <div className="page-container ai-act-page">
      ...
      <section className="ai-act-summary">
        <article className="card"><BrainCircuit/><span className="eyebrow">KI-Funktionen</span><h2>Bewusst begrenzt</h2><p>Reflexion, KI-Kompass-Vertiefung und die genaue Tool-Beratung verwenden nur nach ausdrücklichem Start ein Sprachmodell. Lokale Einordnung, Selbstcheck, Timer und Diagramme funktionieren weiterhin ohne generative KI.</p></article>
